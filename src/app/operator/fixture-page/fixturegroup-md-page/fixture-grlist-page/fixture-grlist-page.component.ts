// angular lib
import {Component, Input, OnInit, OnDestroy, ViewChild, EventEmitter, Output, SimpleChanges, OnChanges} from '@angular/core';
...
export class FixtureGrlistPageComponent implements OnInit, OnChanges, OnDestroy {
