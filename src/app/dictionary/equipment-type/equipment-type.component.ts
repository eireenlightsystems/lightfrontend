      ...
      case 'fixtureType':
        ...
        if (saveEditwinObject.typeEditWindow === 'ins') {
          ...
          this.oSubFixtureType = this.fixtureTypeService.ins(selectObject).subscribe(
            ...
            () => {
              // close edit window
              this.fixtureType.editWindow.closeDestroy();
              // update data source
      ...
      case 'nodeType':
        ...
        if (saveEditwinObject.typeEditWindow === 'ins') {
          ...
          this.oSubNodeType = this.nodeTypeService.ins(selectObject).subscribe(
            ...
            () => {
              // close edit window
              this.nodeType.editWindow.closeDestroy();
              // update data source
      ...
      case 'gatewayType':
        ...
        if (saveEditwinObject.typeEditWindow === 'ins') {
          ...
          this.oSubGatewayType = this.gatewayTypeService.ins(selectObject).subscribe(
            ...
            () => {
              // close edit window
              this.gatewayType.editWindow.closeDestroy();
              // update data source
      ...
      case 'sensorType':
        ...
        if (saveEditwinObject.typeEditWindow === 'ins') {
          ...
          this.oSubSensorType = this.sensorTypeService.ins(selectObject).subscribe(
            ...
            () => {
              // close edit window
              this.sensorType.editWindow.closeDestroy();
              // update data source
