...
export class NodemapPageComponent implements OnInit, OnDestroy {
  ...
  constructor(private zone: NgZone, private nodeService: NodeService, public router: Router, public route: ActivatedRoute) {
  }
    ...
    ymaps.ready().then(() => {
      ...
      let ButtonLayout = ymaps.templateLayoutFactory.createClass([
        ...
        ].join(''),
        {
          ...
          insItem: (function () {
            let mapComponent: NodemapPageComponent = this;
  ...
  addItemsToMap() {
    ...
    for (let node of this.nodes) {
      ...
      var changeCoords = function (mapComponent) {
        return function (e) {
